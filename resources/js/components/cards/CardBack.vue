...
<template>
  <div class=" w-full mx-auto">
    <div class="relative h-56 overflow-hidden bg-gradient-to-tr from-slate-800 to-slate-900 rounded-3xl p-8 shadow-2xl border border-white/10 flex items-center justify-between">
      ...
      <div class="relative z-10 flex-1 flex flex-col justify-center border-r border-white/5 pr-6">
        <div class="flex items-center gap-3">
          <div class="h-8 w-8 bg-white/10 rounded-full flex items-center justify-center border border-white/20">
...
<style scoped>
/* Matching the font style from the front card */
